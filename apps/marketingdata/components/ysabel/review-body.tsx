...
export function ReviewBody({review}:{review:CommunityRecord}) {
  ...
  return <>
    ...
    {!review.reviewPhotos?.length&&<small className="source-asof">Attached photos are not supplied by the Google Reviews API. Available saved review photos appear here.</small>}
  </>;
}
